#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#AIzaSyAit0f-6nPQGZAaUo9AeFdp22zucYvcLuM
"""
...
def geo_json(kml_path):
    ...
    with open(kml_filename, encoding="utf-8") as kml_file:
        ...
        # Iterate through all features recursively
        def extract_polygon_coords(features):
            for feature in features:
                if hasattr(feature, 'geometry') and isinstance(feature.geometry, geometry.Polygon):
                ...
                if hasattr(feature, 'features'):
                    extract_polygon_coords(feature.features)
        
        extract_polygon_coords(k.features)
...
def download_from_gee(start_date, end_date, kml_name, bands):
    ...
    service_account = 'bare-soil@ee-my-baresolil.iam.gserviceaccount.com'
    credentials = ee.ServiceAccountCredentials(service_account, './GEE_key/ee-my-baresolil-fc574ef3be49.json')
