...
class BareSoil:
    ...
    def ndvi_threshold(red_channel, infra_channel, n_lambda=0.4):
        ...
        _, shadow_ndvi = BareSoil.shadow_point(red_channel, infra_channel)
        _, _, red_ndvi, infra_ndvi = BareSoil.endmembers(red_channel, infra_channel)

        return np.min([(red_ndvi * n_lambda), (infra_ndvi * n_lambda), shadow_ndvi])
    ...
    def threshold_percentage(red_channel, infra_channel):
        ...
        threshold = BareSoil.ndvi_threshold(red_channel, infra_channel)
